...
load 'trainedNet0008.mat'; % LSTM proxy model
...
casename  = '(perm1_6(4)_(7)_rnn_up(test1))'; 
...
figure; h_reg = plotregression2(-ecl_fit, -pos_fit); pause(3); 
...
%         figure; h_reg = plotregression2(-eclfitall, -rnnfitall); pause(3); 
        figure; h_reg = plotregression2(-ecl_fit, -pos_fit); pause(3);
        saveas(h_reg, [direc_fig '/regression #' num2str(gen-1) '.png']); close;
        ...
        if ismember(gen-1, [15, 30, 45])
%         if ismember(gen-1, [61])
