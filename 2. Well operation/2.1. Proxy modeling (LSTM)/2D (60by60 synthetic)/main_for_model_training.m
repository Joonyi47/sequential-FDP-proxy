...
for i = 1:Np
   ...
   for j = 1:N
       if opt_type(j) >= 1/3
           ...
           tmp2 = tmp2.*schd(j,:);
           tmp2(tmp2 == 0) = 3500; % null value (initial reservoir pressure in this case)
       else
...
varname = ['Result_(PERM5_5_cnn_up_(13))_' t(1:11) ' ' t(13:14) t(16:17)];   %%% streamline simulation 결과 변수
